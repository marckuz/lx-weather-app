...
const CardWeather = ({ hourData, index }: { hourData: currentConditionsModel, index: number }) => {
    ...
    return (
        <HtmlTooltip title={<Typography color="inherit">{hourData.description}</Typography>}>
            <Card sx={{ maxWidth: 345, background: "linear-gradient(to bottom, #57c1eb 0%,#246fa8 100%)" }} onClick={setSelectedHour(index)}>
                <Link style={{ color: "white" }} to={'/hourly'}>
                    <CardActionArea>
                        ...
                        <CardContent sx={{ textAlign: "center" }}>
                            <img src={getIcon(hourData.conditions)} alt={hourData.conditions} height={100} />
